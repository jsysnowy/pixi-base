// Type definitions for GreenSock GSAP_Animation Platform 1.15.1
...
declare class GSAP_Animation {
    ...
    delay(): number;
    delay(value: number): GSAP_Animation;
    duration(): number;
    duration(value: number): GSAP_Animation;
    eventCallback(type: string): Function;
    eventCallback(type: string, callback: Function, params?: any[], scope?: any): GSAP_Animation;
    invalidate(): GSAP_Animation;
    isActive(): boolean;
    kill(vars?: Object, target?: Object): GSAP_Animation;
    pause(atTime?: any, suppressEvents?: boolean): GSAP_Animation;
    paused(): boolean;
    paused(value: boolean): GSAP_Animation;
    play(from?: any, suppressEvents?: boolean): GSAP_Animation;
    progress(): number;
    progress(value: number, supressEvents?: boolean): GSAP_Animation;
    restart(includeDelay?: boolean, suppressEvents?: boolean): GSAP_Animation;
    resume(from?: any, suppressEvents?: boolean): GSAP_Animation;
    reverse(from?: any, suppressEvents?: boolean): GSAP_Animation;
    reversed(): boolean;
    reversed(value: boolean): GSAP_Animation;
    seek(time: any, suppressEvents?: boolean): GSAP_Animation;
    startTime(): number;
    startTime(value: number): GSAP_Animation;
    time(): number;
    time(value: number, suppressEvents?: boolean): GSAP_Animation;
    timeScale(): number;
    timeScale(value: number): GSAP_Animation;
    totalDuration(): number;
    totalDuration(value: number): GSAP_Animation;
    totalProgress(): number;
    totalProgress(value: number): GSAP_Animation;
    totalTime(): number;
    totalTime(time: number, suppressEvents?: boolean): GSAP_Animation;
}

declare class SimpleTimeline extends GSAP_Animation {
...
//com.greensock
declare class TweenLite extends GSAP_Animation {
    ...
    static globalTimeScale(value?: number): any;
}
