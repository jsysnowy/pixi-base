namespace com.sideplay.core {
    export class ScaleManager {
        // Static instance
        public static instance: ScaleManager = null;
        ...
        public constructor(pixiRenderer: any, mainStage: PIXI.Container) {
            if (ScaleManager.instance == null) {
                ScaleManager.instance = core.scale = this;
        ...
        public fitScaleGroup(group: Group, canvasInformation: object): void {
            ...
            var topOffset = -(
                (this._nativeHeight * canvasInformation["minScale"] - canvasInformation["availHeight"]) *
                group.scaleAnchor.y
            );
        ...
        public expandScaleGroup(group: Group, canvasInformation: object, x: number, y: number): void {
            ...
            var topOffset = -(
                (this._nativeHeight * canvasInformation["minScale"] * maxExpand - canvasInformation["availHeight"]) *
                group.scaleAnchor.y
            );
            var leftOffset = -(
                (this._nativeWidth * canvasInformation["minScale"] * maxExpand - canvasInformation["availWidth"]) *
                group.scaleAnchor.x
            );
    ...
    // Reference
    export var scale: ScaleManager = null;
}
