namespace com.sideplay.core {
    export class Ticket {
        // Singleton Instance.
        public static instance: Ticket = null;
        ...
        public constructor(thirdPartyParams: any[]) {
            if (Ticket.instance == null) {
                ...
                Ticket.instance = core.ticket = this;

                // Setup initial wrapper.
                if (thirdPartyParams[0] == "local") {
                    // Detect IFrame ....
                    if (window.self == window.top || (<any>window.top).ticketPool == null) {
                        // no iframe - loads locally!
                        this._wrapper = new sideplay.ticket.LocalWrapper();
                    } else {
                        // yes iframe - loads testing wrapper!
                        this._wrapper = new sideplay.ticket.TestingWrapper();
                    }
                } else {
                ...
                console.error("Cannot create multiple instances of TicketManager. Please use core.TicketManager.instance or core.ticket instead.");
            }
        }
        ...
        private _callRequestCallback(): void {
            ...
            if (this._trigger) {
                ...
                if (this._requestScope == null) {
                    ...
                    this._requestParams == null ? this._requestCallback.bind(this._requestScope)() : this._requestCallback.bind(this._requestScope)(...this._requestParams);
                }
            }
        }
    }
